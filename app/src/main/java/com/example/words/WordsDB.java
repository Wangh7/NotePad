...
public class WordsDB {
    ...
    public void InsertUserSql(String strWord, String strMeaning) {
        String sql = "insert into  words(_id,word,meaning) values(?,?,?)";

        //Gets the data repository in write mode*/
        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        db.execSQL(sql, new String[]{GUID.getGUID(),strWord, strMeaning});
    }
    ...
    public void Update(String strId, String strWord, String strMeaning) {
        SQLiteDatabase db = mDbHelper.getReadableDatabase();
